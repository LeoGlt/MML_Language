...
public class MmlParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, MmlGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getDTAccess().getGroup_2(), "rule__DT__Group_2__0");
			builder.put(grammarAccess.getDTAccess().getGroup_3(), "rule__DT__Group_3__0");
			...
			builder.put(grammarAccess.getRandomForestAccess().getGroup_4(), "rule__RandomForest__Group_4__0");
			builder.put(grammarAccess.getLogisticRegressionAccess().getGroup(), "rule__LogisticRegression__Group__0");
			builder.put(grammarAccess.getLogisticRegressionAccess().getGroup_2(), "rule__LogisticRegression__Group_2__0");
			builder.put(grammarAccess.getLogisticRegressionAccess().getGroup_3(), "rule__LogisticRegression__Group_3__0");
			builder.put(grammarAccess.getLogisticRegressionAccess().getGroup_4(), "rule__LogisticRegression__Group_4__0");
			...
			builder.put(grammarAccess.getSVMAccess().getGammaSpecifiedAssignment_2_0(), "rule__SVM__GammaSpecifiedAssignment_2_0");
			builder.put(grammarAccess.getSVMAccess().getGammaAssignment_2_1(), "rule__SVM__GammaAssignment_2_1");
			builder.put(grammarAccess.getSVMAccess().getCSpecifiedAssignment_3_0(), "rule__SVM__CSpecifiedAssignment_3_0");
			...
			builder.put(grammarAccess.getDTAccess().getMaxdepthSpecifiedAssignment_2_0(), "rule__DT__MaxdepthSpecifiedAssignment_2_0");
			builder.put(grammarAccess.getDTAccess().getMax_depthAssignment_2_1(), "rule__DT__Max_depthAssignment_2_1");
			builder.put(grammarAccess.getDTAccess().getCriterionSpecifiedAssignment_3_0(), "rule__DT__CriterionSpecifiedAssignment_3_0");
			builder.put(grammarAccess.getDTAccess().getCriterionAssignment_3_1(), "rule__DT__CriterionAssignment_3_1");
			builder.put(grammarAccess.getRandomForestAccess().getNestimSpecifiedAssignment_2_0(), "rule__RandomForest__NestimSpecifiedAssignment_2_0");
			...
			builder.put(grammarAccess.getRandomForestAccess().getMaxdepthSpecifiedAssignment_3_0(), "rule__RandomForest__MaxdepthSpecifiedAssignment_3_0");
			builder.put(grammarAccess.getRandomForestAccess().getMax_depthAssignment_3_1(), "rule__RandomForest__Max_depthAssignment_3_1");
			builder.put(grammarAccess.getRandomForestAccess().getCriterionSpecifiedAssignment_4_0(), "rule__RandomForest__CriterionSpecifiedAssignment_4_0");
			builder.put(grammarAccess.getRandomForestAccess().getCriterionAssignment_4_1(), "rule__RandomForest__CriterionAssignment_4_1");
			builder.put(grammarAccess.getLogisticRegressionAccess().getPenaltySpecifiedAssignment_2_0(), "rule__LogisticRegression__PenaltySpecifiedAssignment_2_0");
			builder.put(grammarAccess.getLogisticRegressionAccess().getPenaltyAssignment_2_1(), "rule__LogisticRegression__PenaltyAssignment_2_1");
			builder.put(grammarAccess.getLogisticRegressionAccess().getTolSpecifiedAssignment_3_0(), "rule__LogisticRegression__TolSpecifiedAssignment_3_0");
			builder.put(grammarAccess.getLogisticRegressionAccess().getTolAssignment_3_1(), "rule__LogisticRegression__TolAssignment_3_1");
			builder.put(grammarAccess.getLogisticRegressionAccess().getCSpecifiedAssignment_4_0(), "rule__LogisticRegression__CSpecifiedAssignment_4_0");
			builder.put(grammarAccess.getLogisticRegressionAccess().getCAssignment_4_1(), "rule__LogisticRegression__CAssignment_4_1");
